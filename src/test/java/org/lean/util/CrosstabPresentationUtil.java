...
public class CrosstabPresentationUtil extends BasePresentationUtil {
  ...
  public LeanPresentation createCrosstabPresentationOnlyVerticalDimensions( int nr ) throws Exception {
    ...
    crosstab.setVerticalDimensions( Arrays.asList(
      ...
      new LeanDimension( "name", "Name", LeanHorizontalAlignment.LEFT, LeanVerticalAlignment.TOP ),
      new LeanDimension( "updated", "Time of update", LeanHorizontalAlignment.LEFT, LeanVerticalAlignment.TOP ),
      new LeanDimension( "important", "Imp?", LeanHorizontalAlignment.CENTER, LeanVerticalAlignment.TOP )
    ) );
    LeanFact sumFact = new LeanFact( "random", "Sum", LeanHorizontalAlignment.RIGHT, LeanVerticalAlignment.TOP, AggregationMethod.SUM, "#.000");
    sumFact.setHorizontalAggregation( true );
    sumFact.setHorizontalAggregationHeader( "Total Sum" );
    sumFact.setHeaderHorizontalAlignment( LeanHorizontalAlignment.CENTER );
    sumFact.setHeaderVerticalAlignment( LeanVerticalAlignment.TOP );
    sumFact.setFormatMask( "0.00" );
    LeanFact countFact = new LeanFact( "name", "Count", LeanHorizontalAlignment.RIGHT, LeanVerticalAlignment.TOP, AggregationMethod.COUNT, "#");
    countFact.setHorizontalAggregation( true );
    countFact.setHorizontalAggregationHeader( "Total Count" );
    countFact.setHeaderHorizontalAlignment( LeanHorizontalAlignment.CENTER );
  ...
  public LeanPresentation createCrosstabPresentationOnlyHorizontalDimensions( int nr ) throws Exception {
    ...
    LeanCrosstabComponent crosstab = new LeanCrosstabComponent( CONNECTOR_SAMPLE_ROWS );
    crosstab.setHorizontalDimensions( Arrays.asList(
      new LeanDimension( "color", "Color", LeanHorizontalAlignment.CENTER, LeanVerticalAlignment.TOP ),
      new LeanDimension( "important", "?", LeanHorizontalAlignment.CENTER, LeanVerticalAlignment.TOP )
