...
public class CompositePresentationUtil extends BasePresentationUtil {
  ...
  public static LeanPresentation createSimpleCompositePresentation( int nr ) throws Exception {
...

    {
      ...
      // null below means: relative to parent (page or composite)
      //
      label2Layout.setRight( new LeanAttachment( COMPONENT_NAME_LABEL1, 0, 0, LeanAttachment.Alignment.RIGHT ) );
      label2Layout.setTop( new LeanAttachment( COMPONENT_NAME_LABEL1, 0, 5, LeanAttachment.Alignment.BOTTOM ) );
