...
public class TablePresentationUtil extends BasePresentationUtil {
  ...
  public static LeanPresentation createTablePresentation( int nr ) throws Exception {
    ...
    //
    ILeanConnector sqlSource = new LeanSqlConnector( connection.getName(), "SELECT * FROM " + tableName );
    ...
    List<LeanColumn> columnSelection = Arrays.asList(
      ...
      new LeanColumn( "updated", "Time of update", LeanHorizontalAlignment.LEFT, LeanVerticalAlignment.TOP ),
      new LeanColumn( "important", "Imp?", LeanHorizontalAlignment.CENTER, LeanVerticalAlignment.TOP ),
      new LeanColumn( "color", "Color", LeanHorizontalAlignment.CENTER, LeanVerticalAlignment.TOP ),
      new LeanColumn( "random", "Random Nr.", LeanHorizontalAlignment.LEFT, LeanVerticalAlignment.TOP )
    );
    ...
    LeanTableComponent table = new LeanTableComponent( passThroughConnector.getName(), columnSelection );
    ...
    labelLayout.setLeft( new LeanAttachment( COMPONENT_NAME_TABLE, 0, 0, LeanAttachment.Alignment.LEFT ) );
    labelLayout.setRight( new LeanAttachment( COMPONENT_NAME_TABLE, 0, 0, LeanAttachment.Alignment.RIGHT ) );
    labelLayout.setTop( new LeanAttachment( COMPONENT_NAME_TABLE, 0, 30, LeanAttachment.Alignment.BOTTOM ) );
    label1.setLayout( labelLayout );
    label1.setSize( null );
  ...
  public static LeanPresentation createTableChainPresentation( int nr ) throws Exception {
    ...
    // Sort
    //
    List<LeanSortMethod> sorts = Arrays.asList(
