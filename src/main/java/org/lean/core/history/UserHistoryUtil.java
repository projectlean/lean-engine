...
public class UserHistoryUtil {
  ...
  public static final void addUserHistoryAction(
    ...
    IHopMetadataSerializer<LeanUserHistory> serializer =
        metadataProvider.getSerializer(LeanUserHistory.class);
    ...
    for (String type : typeActionsMap.keySet()) {
      ...
      Collections.sort(
          actions,
          new Comparator<LeanUserHistoryAction>() {
            @Override
            public int compare(LeanUserHistoryAction o1, LeanUserHistoryAction o2) {
  ...
  public static final List<LeanUserHistoryAction> getUserHistoryActions(
